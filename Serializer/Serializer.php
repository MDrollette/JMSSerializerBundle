...
class Serializer implements SerializerInterface
{
    ...
    public function serialize($data, $format)
    {
        ...
        $visitor->setNavigator($navigator = new GraphNavigator(GraphNavigator::DIRECTION_SERIALIZATION, $this->factory, $this->exclusionStrategy, $this->dispatcher));
    ...
    public function deserialize($data, $type, $format)
    {
        ...
        $visitor->setNavigator($navigator = new GraphNavigator(GraphNavigator::DIRECTION_DESERIALIZATION, $this->factory, $this->exclusionStrategy, $this->dispatcher));
